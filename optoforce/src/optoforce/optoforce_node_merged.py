...
class OptoforceNode(object):
    ...
    def __init__(self):
        ...
        self.pub_merge = rospy.Publisher("/optoforce_norm_rh" , Float64MultiArray, queue_size=1)
    ...
    def _publish(self, data):
        ...
        for i in range(self._driver.nb_sensors()):
            ...
            force_array[i] = np.linalg.norm(np.array([data.force[i][0], data.force[i][1], data.force[i][2]]),2)
        ...
        my_msg.data = force_array
        self.pub_merge.publish(my_msg)
